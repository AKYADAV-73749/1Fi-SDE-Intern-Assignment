...
const ProductCard = ({ product, isSelected, selectedVariant, onSelectProduct, onSelectVariant, emiPlans, selectedEMI, onSelectEMI, onCheckout }) => {
  return (
    <View style={[styles.card, isSelected && styles.cardSelected]}>
      ...
      {/* Main Product Info (Clickable to select) */}
      ...
      {/* EMI Plans (Expands smoothly when product and variant are selected) */}
...
const styles = StyleSheet.create({
  card: {
    ...
    borderRadius: 24, // Very soft, modern rounded corners
    padding: 20,
    marginBottom: 20,
    borderWidth: 1,
    borderColor: '#F3F4F6', // Extremely subtle border
    shadowColor: '#6C28D9', // Purple tinted shadow
  ...
  chip: {
    ...
    borderRadius: 12, // Squarish premium look
    borderWidth: 1,
    borderColor: '#E5E7EB',
    backgroundColor: '#ffffff',
  },
  ...
  emiCard: {
    ...
    borderColor: '#E5E7EB',
    backgroundColor: '#F9FAFB',
    alignItems: 'flex-start', // Left aligned feels more like a receipt/ticket
    marginBottom: 4,
  },
  emiCardActive: {
  ...
  emiInterest: {
    fontSize: 12,
    fontWeight: '500',
    color: '#10B981', // Success green for 0% interest
  },
  emiTextActive: {
    color: '#6C28D9',
  },
